...
def process_video(video_path):
    ...
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # Ensure MP4 format compatibility
    ...
    while cap.isOpened():
        ...
        inpBlob = cv2.dnn.blobFromImage(frame, 1.0, (width, height), (127.5, 127.5, 127.5), swapRB=True, crop=False)
